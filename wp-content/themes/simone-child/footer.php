...
?>
	...
	<footer id="colophon" class="site-footer" role="contentinfo">
		...
		<div class="site-info">
			...
			echo "<a href=\"http://stlcc.edu\">&copy; " . date("Y") . " St. Louis Community College</a>" ;
			//printf(
			...
			<span class="sep"> | </span>
			<?php echo "<a href=\"http://stlcc.edu/Diversity/\">Diversity</a>"; ?>

			<span class="sep"> | </span>
			<?php echo "<a href=\"http://stlcc.edu/Legal/\">Legal</a>"; ?>
